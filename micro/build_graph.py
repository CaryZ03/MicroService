...
api_file_path = "./examples/springboot_demo_apis.json"

graph_builder = GraphBuilder("java-app", api_file_path)
graph_builder.load_dynamic_info("./examples/dynamic_info.json")
...
api_file_path = "./examples/flask_demo_apis.json"
...
# graph_builder.save_dynamic_info("./examples/dynamic_info.json")
graph_builder.generate_graph()
