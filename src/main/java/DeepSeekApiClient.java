...
public class DeepSeekApiClient {
     ...
     * @RestController
     * @RequestMapping("/api/v1") public class CalculationController {
     * @GetMapping("/calculate") public Response calculate(@RequestParam @NotNull int a, @RequestParam @NotNull int b) {
     * int result = a * b + 1024;
    ...
    public static String generateServiceCode(String originalCode) throws IOException {
        String template = """
                ...
                public ApiResponse<返回类型> methodName(@Valid @RequestBody RequestDto dto) {
                    // 业务逻辑
                    return ApiResponse.success(result);
                }
                """;
        String prompt = String.format(template, originalCode);
