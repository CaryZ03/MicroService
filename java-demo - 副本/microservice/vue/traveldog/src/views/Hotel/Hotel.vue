<template>
    <div class="hotels">
                ...
                <div class="search-area">
                    ...
                    <div class="block">
                        <el-date-picker v-model="dateRange" type="daterange" range-separator="至"
                            start-placeholder="预订入住日期" end-placeholder="预订退房日期" @blur="handleDateBlur"></el-date-picker>
                    </div>
                </div>
                <!-- 搜索区域 -->
                <div class="header">
        ...
        <div class="Hotel" v-show="searchFlag">
            ...
            <!--表格区域展示视图数据-->
            <div class="wrapper">
                <el-table :data="hotelsPaginatedData" style="width: 100%"
...
export default {
    ...
    methods: {
        ...
        async getCustomersAlreadyBookHotels(hid) {
            try {
                let resp = await this.axios.get(`/user-service-api-8084/customer/getCidByHid/${hid}`);
                let data = resp.data;
        ...
        async searchHotels() {
            ...
            try {
                const resp = await this.axios.post(`/hotel-service-api-8080/hotel/getByLocation`, this.searchForm);
                let data = resp.data;
