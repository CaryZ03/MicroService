...
export default {
  ...
  if (messageToMarkAsRead) {  
    ...
    setupWebSocket() {
      this.websocket = new WebSocket("ws://localhost:8082/websocket"); // 创建WebSocket连接
