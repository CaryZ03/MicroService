<template>
    <div class="platform">
        ...
        <!--右侧内容区域-->
        <Content class="content" :class="{isActive:isCollapse}" @changeCollapse="changeCollapse" @changeDrawer="changeDrawer" :isCollapse="isCollapse"/>
        <!-- 弹出框 -->
...
export default {
    ...
    methods:{
        ...
        async clearLogin() {
            ...
            await this.axios.post(`/api/logout`,submitForm).then((resp) => {
            });
        }
    },
    mounted() {
