...
public class OrderServiceImpl extends ServiceImpl<UserOrderMapper, UserOrder> implements OrderService {
    ...
    public List<UserOrderDemo> getUserOrdersByUid(String uid) {
        ...
        for (UserOrder userOrder : userOrderList) {
            ...
            UserOrderDemo userOrderDemo = new UserOrderDemo(oid, userOrder.getUserId(), userOrder.getType(), userOrder.getAddTime(), userOrder.getStatus(), userOrder.getPrice(), userOrder.isComment());
            String cname;
            String tid;
            String hname;
            switch(userOrder.getType()) {
                case "hotelOrder":
                    ...
                    for (HotelCustomerOrder tmpHco : hcos) {
                        ...
                        HotelCustomerOrderDemo hcod = new HotelCustomerOrderDemo(cid, cname, tmpHco.getPrice(), hname, tmpHco.getRoomNumber(), tmpHco.getFromTime(), tmpHco.getToTime());
                        hcods.add(hcod);
                    }
                ...
                case "trainOrder":
                    ...
                    for (TrainCustomerOrder tmpTco : tcos) {
                        ...
                        TrainCustomerOrderDemo tcod = new TrainCustomerOrderDemo(tmpTco.getCustomerId(), cname, tmpTco.getPrice(), tmpTco.getTrainId(), tmpTco.getSeatNumber(), tmpTco.getSeatType(), departureLocation, arriveLocation, tmpTco.getDepartureTime(), tmpTco.getArriveTime());
                        tcods.add(tcod);
                    }
                ...
                case "mealOrder":
                    ...
                    for (MealCustomerOrder mco : mcos) {
                        ...
                        MealCustomerOrderDemo mcod = new MealCustomerOrderDemo(tid, mco.getCustomerId(), cname, mco.getPrice(), mname);
                        mcods.add(mcod);
                    }
                    userOrderDemo.setTid(tid);
