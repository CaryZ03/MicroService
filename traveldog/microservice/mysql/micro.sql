...
drop table if exists order_service.hotel_comment;
drop table if exists order_service.hotel_orders;
drop table if exists order_service.trains_orders;
drop table if exists order_service.meal_orders;
drop table if exists order_service.orders;
drop table if exists user_service.users_customers;
drop table if exists user_service.user_notice;
drop table if exists user_service.customers;
...
drop table if exists hotel_service.hotel_comment;
drop table if exists hotel_service.hotel_room;
drop table if exists order_service.hotel_orders;
drop table if exists hotel_service.hotels;
drop table if exists train_service.train_arrivals;
drop table if exists order_service.trains_orders;
drop table if exists location_service.locations;
...
drop table if exists order_service.hotel_comment;
drop table if exists hotel_service.hotels;
drop table if exists hotel_service.rooms;

drop database if exists hotel_service;
...
primary key(h_id),
foreign key(l_id) references location_service.locations(l_id) on delete cascade on update cascade
);
...
foreign key(h_id) references hotels(h_id) on delete cascade on update cascade,
foreign key(r_id) references rooms(r_id) on delete cascade on update cascade
);
...
drop table if exists train_meal;
...
foreign key(t_id) references trains(t_id) on delete cascade on update cascade,
foreign key(m_id) references meals(m_id) on delete cascade on update cascade
);
...
foreign key(t_id) references trains(t_id) on delete cascade on update cascade,
foreign key(s_type) references seat_price(s_type) on delete cascade on update cascade
);
...
('A01', 1, '2024-08-31 18:00:00', 1, '北京省北京市'),
('A01', 2, '2024-08-31 20:00:00', 2, '江苏省南京市'),
('A01', 4, '2024-08-31 21:00:00', 3, '湖南省长沙市'),
('A01', 7, '2024-08-31 23:00:00', 4, '重庆省重庆市'),
('A01', 9, '2024-08-31 23:30:00', 5, '浙江省杭州市'),
('B02', 2, '2024-08-31 19:00:00', 1, '江苏省南京市'),
('B02', 3, '2024-08-31 21:30:00', 2, '贵州省贵阳市'),
('B02', 5, '2024-08-31 22:30:00', 3, '上海省上海市'),
('B02', 6, '2024-08-31 23:45:00', 4, '天津省天津市'),
('C03', 4, '2024-08-31 18:00:00', 1, '湖南省长沙市'),
('C03', 8, '2024-08-31 20:00:00', 2, '四川省成都市'),
('D04', 1, '2024-08-31 18:00:00', 1, '北京省北京市'),
('D04', 2, '2024-08-31 20:00:00', 2, '江苏省南京市'),
('D04', 7, '2024-08-31 23:00:00', 3, '重庆省重庆市'),
('D04', 9, '2024-08-31 23:30:00', 4, '浙江省杭州市'),
('E05', 2, '2024-08-31 07:00:00', 1, '江苏省南京市'),
('E05', 3, '2024-08-31 08:00:00', 2, '贵州省贵阳市'),
('E05', 4, '2024-08-31 09:00:00', 3, '湖南省长沙市'),
('F06', 7, '2024-08-31 02:00:00', 1, '重庆省重庆市'),
('F06', 9, '2024-08-31 10:30:00', 2, '浙江省杭州市'),
('F06', 1, '2024-08-31 21:00:00', 3, '北京省北京市'),
('G07', 8, '2024-08-31 20:00:00', 1, '四川省成都市'),
('G07', 5, '2024-08-31 21:00:00', 2, '上海省上海市'),
('H08', 7, '2024-08-31 23:00:00', 1, '重庆省重庆市'),
('H08', 9, '2024-08-31 23:30:00', 2, '浙江省杭州市'),
('H08', 4, '2024-08-31 18:00:00', 3, '湖南省长沙市'),
('H08', 5, '2024-08-31 20:00:00', 4, '上海省上海市'),
('H08', 6, '2024-08-31 21:00:00', 5, '天津省天津市'),
('I09', 6, '2024-08-31 23:00:00', 1, '天津省天津市'),
('I09', 2, '2024-08-31 23:30:00', 2, '江苏省南京市'),
('I09', 5, '2024-08-31 18:00:00', 3, '上海省上海市'),
('J10', 1, '2024-08-31 12:00:00', 1, '北京省北京市'),
('J10', 2, '2024-08-31 13:00:00', 2, '江苏省南京市'),
('J10', 3, '2024-08-31 14:00:00', 3, '贵州省贵阳市'),
('J10', 4, '2024-08-31 15:00:00', 4, '湖南省长沙市'),
('J10', 5, '2024-08-31 16:00:00', 5, '上海省上海市'),
('J10', 6, '2024-08-31 17:00:00', 6, '天津省天津市'),
('J10', 7, '2024-08-31 18:00:00', 7, '重庆省重庆市'),
('J10', 8, '2024-08-31 19:00:00', 8, '四川省成都市'),
('J10', 9, '2024-08-31 20:00:00', 9, '浙江省杭州市'),
('K11', 1, '2024-08-31 12:30:00', 1, '北京省北京市'),
('K11', 4, '2024-08-31 13:30:00', 2, '湖南省长沙市'),
('K11', 7, '2024-08-31 14:30:00', 3, '重庆省重庆市'),
('K11', 2, '2024-08-31 15:30:00', 4, '江苏省南京市'),
('K11', 5, '2024-08-31 16:30:00', 5, '上海省上海市'),
('K11', 8, '2024-08-31 17:30:00', 6, '四川省成都市'),
('K11', 3, '2024-08-31 18:30:00', 7, '贵州省贵阳市'),
('K11', 6, '2024-08-31 19:30:00', 8, '天津省天津市'),
('K11', 9, '2024-08-31 20:30:00', 9, '浙江省杭州市');
...
is_comment boolean,
primary key(o_id),
foreign key(u_id) references user_service.users(u_id) on delete cascade on update cascade
);
...
foreign key(c_id) references user_service.customers(c_id) on delete cascade on update cascade,
foreign key(h_id) references hotel_service.hotels(h_id) on delete cascade on update cascade,
foreign key(r_id) references hotel_service.rooms(r_id) on delete cascade on update cascade
);
...
content varchar(500),
primary key(hc_id),
foreign key(o_id) references hotel_orders(o_id) on delete cascade on update cascade,
foreign key(h_id) references hotel_service.hotels(h_id) on delete cascade on update cascade
);
...
foreign key(o_id) references orders(o_id) on delete cascade on update cascade,
foreign key(c_id) references user_service.customers(c_id) on delete cascade on update cascade,
foreign key(t_id) references train_service.trains(t_id) on delete cascade on update cascade,
foreign key(departure_location) references location_service.locations(l_id) on delete cascade on update cascade,
foreign key(arrive_location) references location_service.locations(l_id) on delete cascade on update cascade
);
...
foreign key(o_id) references orders(o_id) on delete cascade on update cascade,
foreign key(c_id) references user_service.customers(c_id) on delete cascade on update cascade,
foreign key(m_id) references train_service.meals(m_id) on delete cascade on update cascade,
foreign key(t_id) references train_service.trains(t_id) on delete cascade on update cascade
);