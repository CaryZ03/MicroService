...
public class TrainController {
    ...
    public BaseRsp updateTrain(@RequestBody TrainReq Req) {
        ...
        if(Req.getUid() != null){
            rsp.setSuccess(true);
            rsp.setMessage("update train success!");
            rsp.setContent(null);
        }
        else{
            rsp.setSuccess(false);
            rsp.setMessage("update train fail!");
            rsp.setContent(null);
        }
        return rsp;
    }
    ...
    public BaseRsp deleteTrainByTid(@PathVariable("tid") Integer tid) {
        BaseRsp rsp = new BaseRsp();
        if(tid != -1){
            rsp.setSuccess(true);
            rsp.setMessage("delete train success!");
            rsp.setContent(null);
        }
        else{
            rsp.setSuccess(false);
            rsp.setMessage("delete train fail!");
            rsp.setContent(null);
        }
        return rsp;
    }
