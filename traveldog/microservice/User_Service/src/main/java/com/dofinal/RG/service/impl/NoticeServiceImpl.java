...
public class NoticeServiceImpl extends ServiceImpl<UserNoticeMapper, UserNotice> implements NoticeService {
    ...
    @Override
    public Integer insertUserNotice(UserNotice userNotice){
        return userNoticeMapper.insertUserNotice(userNotice);
    }

    @Override
    public Integer updateStatus(int nid){
        return userNoticeMapper.updateStatus(nid);
    }

    @Override
    public Integer deleteNotice(int nid){
        return userNoticeMapper.deleteNotice(nid);
    }
}
